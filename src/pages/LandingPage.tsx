...
const LandingPage = () => {
  ...
  return (
    <div className=" flex flex-col justify-center items-center gap-8">
      <div className="p-8 w-full flex flex-col gap-3 justify-center items-center lg:w-[800px]">
      ...
      <div className="p-8 flex flex-wrap gap-2 justify-center items-center lg:w-[800px]">
        <img
          src={Rectangle4}
          alt="therapist"
      ...
      <div className="px-8 w-full flex flex-col justify-start items-start gap-3 lg:w-[800px]">
      ...
      <div className="p-8 w-full flex flex-col justify-center items-center gap-5 lg:w-[800px]">
        ...
        <div className="px-8 relative flex flex-wrap gap-2 justify-center items-center bg-gray-50 h-[300px]">
          <img
            src={Meditate}
            alt="therapist"
